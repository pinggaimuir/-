...
public class DLPriceFetch {
	...
	public List<String> transSQLDL(int timeint, List<List<String>> datas) {
		...
		for (int i = 1; i < datas.size(); i++) {
			...
			p.setVarName(Integer.valueOf(vMap.get(temp).variety)+"");
	...
	public static void main(String[] args) {
		...
		Date dateStart = DateTimeUtil.parseDateTime("20170310", "yyyyMMdd");
		Date dateEnd = DateTimeUtil.parseDateTime("20170316", "yyyyMMdd");
