...
public class LandData {
	...
	private void fetchFoodSecurity(){
		logger.info("======开始抓取全球土地数据=====");
		String comp = "'\\(([0-9|,|'|-]*)\\)',";
		Map<String, String> dataMap = new HashMap<String, String>();
		postParams.put("json", postParams.get("json").replaceAll("@DomainCode = '([^']+)',", "@DomainCode = 'RL',"));
		for(String varNameTmp:ParamsMap.faostat_land_varname2headers_map.keySet()){
			...
			Map<String, String> headerMap = ParamsMap.faostat_land_varname2headers_map.get(varNameTmp);
			//countries
			...
			//items
			Map<String, String> cnNameMap = ParamsMap.faostat_land_varname2cnnames_map.get(varNameTmp);
