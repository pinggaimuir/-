...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'">
		...
		<td>${m.remark}</td>
		<td>
            <c:if test="${m.state==1}"><a href="stop?moduleId=${m.moduleId}" style="color: darkgreen"> 启用</a></c:if>
            <c:if test="${m.state==0}"><a href="start?moduleId=${m.moduleId}" style="color: red"> 停用</a></c:if>
        </td>
	</tr>
	</c:forEach>
