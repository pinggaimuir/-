...
//            getScreenShot(driver, "jietu");
            ...
            for (int i = 0; i < totalPage; i++) {
                ...
                driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
                js.executeScript("$('div.searchbar div a:last')[0].click()");
//                js.executeScript("arguments[0].click();",(WebElement)document.sel("//nav/div/section[@class='header-11-sub dm-controlsView-holder']/div/div[@class='col-md-8 list-nav']/a[contains(span/text(),'下一篇')]").get(0));
...
//        }
    ...
    public static WuSongInfo parsePage(JXDocument document){
        ...
        //文书来源
        String sourceName=getInfoListByXpath(document,"//span[@ng-if='judgementInfo.sourceName']/text()");
        System.out.println(sourceName);
        wusong.setSourceName(sourceName);
        //期刊号
...
//        System.out.println(deskCase);
        ...
        //原告诉称
        String plaintiffSaid=getInfoListByXpath(document,"//section[@ng-mouseup='showSearchDialogAfterSelectedTxt($event)']/article[header/text()='原告诉称']/section/span/span/text()");
        System.out.println("原告诉称:"+plaintiffSaid);
        wusong.setPlaintiffSaid(plaintiffSaid);
        //被上诉人辩称
        String argument=getInfoListByXpath(document,"//section[@ng-mouseup='showSearchDialogAfterSelectedTxt($event)']/article[header/text()='被告辩称']/section/span/span/text()");
        ...
        //二审裁判结果
        String secondResult=getInfoListByXpath(document,"//section[@ng-mouseup='showSearchDialogAfterSelectedTxt($event)']/article[header/text()='裁判结果']/section/span/span/text()");
