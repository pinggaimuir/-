...
public class ProxyManagerUtil {
	...
	private static void selectFromDB(){
		try{
			...
			String sql = "select top " + Constants.proxyFetchNum + " proxy from ProxyInfo where useful = 1 and lately_status = '1' order by success_rate desc, lately_status_times desc;";
