...
public class UvBolt extends BaseRichBolt {
    ...
    public void execute(Tuple tuple) {
        ...
        List<FluxInfo> list= HbaseDao.queryData(""+tuple.getStringByField("time")+"_"+tuple.getStringByField("uv_id"+"_.*$"));
    ...
    public void declareOutputFields(OutputFieldsDeclarer outputFieldsDeclarer) {
        outputFieldsDeclarer.declare(new Fields("time","uv_id","ss_id","ss_time","urlname","cip","pv","uv"));
    }
}
