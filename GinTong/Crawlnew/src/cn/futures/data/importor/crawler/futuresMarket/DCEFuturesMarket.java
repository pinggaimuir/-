...
public class DCEFuturesMarket {
	...
	private final String industry="期货行情数据-大连商品交易所";
					...
					if(varId != -1){
						if(varName.equals("大连玉米淀粉") ||varName.equals("大连棕榈油") ||varName.equals("大连鸡蛋")){
							...
							for(MarketPrice price:prices){
								price.setCnName( monthMap.get(price.getCnName()));
							}
						}else{
						...
						//存储数据
						priceDao.dbm3Save(removePrices,industry);
					}
				}
			}
		}else{
