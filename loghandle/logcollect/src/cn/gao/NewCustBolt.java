...
public class NewCustBolt extends BaseRichBolt {
    ...
    public void execute(Tuple tuple) {
        ...
        List<FluxInfo> list= HbaseDao.queryData("^[^_]*_"+tuple.getStringByField("uv_id")+"_.*$");
    ...
    public void declareOutputFields(OutputFieldsDeclarer outputFieldsDeclarer) {
        outputFieldsDeclarer.declare(new Fields("time","uv_id","ss_id","ss_time","urlname","cip","pv","uv","vv","newip","newcust"));
    }
}
