...
public class ImportIndustryMapData {
	...
	public static void main(String[] args) {
		...
		String filePath = "C:\\Users\\bric_yangyulin\\Desktop\\临时文件\\企业信息汇总表-20170309.xlsx";
		String[][] files = {{filePath, "1.谷物加工（新）"}, {filePath, "2.食糖加工（新）"}, 
				{filePath, "3.饲料企业（新）"}, {filePath, "4.油厂（新）"}, {filePath, "5.生猪（新）"}};
