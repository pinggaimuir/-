...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/script/registCheck.js">
    </script>
    <script type="text/javascript">
        //更改访问验证码的路径，实现换验证码
        function changeImg(imgObj) {
            imgObj.src = "${pageContext.request.contextPath}/valiImageServlet?time=" + new Date().getTime();
        }
        //长治用户重复登陆
        function checkUserName() {
            ...
            //建立连接
            xhr.open("GET", "${pageContext.request.contextPath}/checkUserNameServlet?username="+username, true);
            //发送请求
   ...
   <%--     <tr>
        ...
        <tr>
            ...
            <td><input type="text" name="valistr" onblur="checkNull('valistr','验证码不能为空')">
                <img id="yzm_img" src="${pageContext.request.contextPath}/valiImageServlet" style="cursor: pointer"
